        ...
        <table id="member">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="addTroops"><input class="addTroops" name="u1" id="u1" value="<?php echo $units['u1']; ?>" maxlength="10">&nbsp;&nbsp;&nbsp;<font color="#bcbcbc" size="1">Currently: <b><?php echo $units['u1']; ?></b>
                            <font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input class="addTroops" name="u2" id="u2" value="<?php echo $units['u2']; ?>" maxlength="10">&nbsp;&nbsp;&nbsp;<font color="#bcbcbc" size="1">Currently: <b><?php echo $units['u2']; ?></b>
                            <font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input class="addTroops" name="u3" id="u3" value="<?php echo $units['u3']; ?>" maxlength="10">&nbsp;&nbsp;&nbsp;<font color="#bcbcbc" size="1">Currently: <b><?php echo $units['u3']; ?></b>
                            <font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input class="addTroops" name="u4" id="u4" value="<?php echo $units['u4']; ?>" maxlength="10">&nbsp;&nbsp;&nbsp;<font color="#bcbcbc" size="1">Currently: <b><?php echo $units['u4']; ?></b>
                            <font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input class="addTroops" name="u5" id="u5" value="<?php echo $units['u5']; ?>" maxlength="10">&nbsp;&nbsp;&nbsp;<font color="#bcbcbc" size="1">Currently: <b><?php echo $units['u5']; ?></b>
                            <font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input class="addTroops" name="u6" id="u6" value="<?php echo $units['u6']; ?>" maxlength="10">&nbsp;&nbsp;&nbsp;<font color="#bcbcbc" size="1">Currently: <b><?php echo $units['u6']; ?></b>
                            <font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input class="addTroops" name="u7" id="u7" value="<?php echo $units['u7']; ?>" maxlength="10">&nbsp;&nbsp;&nbsp;<font color="#bcbcbc" size="1">Currently: <b><?php echo $units['u7']; ?></b>
                            <font>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input class="addTroops" name="u8" id="u8" value="<?php echo $units['u8']; ?>" maxlength="10">&nbsp;&nbsp;&nbsp;<font color="#bcbcbc" size="1">Currently: <b><?php echo $units['u8']; ?></b>
                            <font>
                    </td>
                </tr>
...
<?php } ?>
<br /><br />
<div align="right"><?php if (isset($_GET['d'])) {
