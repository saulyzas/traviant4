    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                ?>
                <input disabled="disabled" style="width: 80%;" class="fm" name="quest" value="<?php echo $questinfo; ?>"> <a href="admin.php?p=editUser&uid=<?php echo $id; ?>"><img src="../img/admin/edit.gif" title="Edit Quest"></a>
            </td>
        </tr>
        <tr>
