                        ...
                        <td class="menu">
                            ...
                            if ($funct->CheckLogin()) { ?>
                                <?php if ($_SESSION['access'] == ADMIN) { ?>
                                    ...
                                    <a href="?p=admin_log">
                                        <font color="Red"><b>Admin Log</font></b>
                                    </a>
                    ...
                    if ($funct->CheckLogin()) {
                        if ($_POST or $_GET) {
                            ...
                            if ($_POST['p'] and $_POST['s']) {
                                $filename = '../Templates/Admin/results_' . $_POST['p'] . '.php';
                                if (file_exists($filename)) {
                                    include($filename);
                                } else {
                                    include('../Templates/Admin/404.php');
