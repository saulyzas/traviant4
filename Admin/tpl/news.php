...
<div id="div_1">
        ...
        <table align="center" width="404" cellpadding="1" cellspacing="1" border="1">
            ...
            <tr>
                ...
                <td valign="top">
                    <center>
                        <font size=3>
                            <label>1 <input type="radio" name="n" value="1" <?php if (isset($_GET['n'])) {
                                                                                if ($_GET['n'] == 1) {
                            ...
                            <label>2 <input type="radio" name="n" value="2" <?php if (isset($_GET['n'])) {
                                                                                if ($_GET['n'] == 2) {
                                                                                    echo 'checked="checked"';
                                                                                }
                                                                            } ?> /></label>
            ...
            <tr>
                ...
                <td valign="top">
                    <center><input type="text" name="title" value="" size=30>
                </td>
            </tr>
            <tr>
                <td align="center"><strong>متن خبر:</strong></td>
                <td valign="top">
                    <center><textarea name="txt" cols="40" rows="10"></textarea>
                </td>
            </tr>
            <tr>
                <td height="26" valign="top" colspan="2"><br />
                    <center>
                        ...
                        <button name="reset" type="reset" value="reset" id="reset" class="reset">
                            <div class="button-container">
                                <div class="button-position">
                                    <div class="btl">
                                        <div class="btr">
    ...
    if ($_POST['action'] == 'News') {
        ...
        if ($text) {
            ...
            unlink('../Templates/News/newsbox' . $number . '.php');
            $file = fopen('../Templates/News/newsbox' . $number . '.php', 'w+');
            fwrite($file, '' . $st . '' . $text . '');
