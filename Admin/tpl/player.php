...
?>
                    ...
                    <td class="details">
                        ...
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td><?php //echo $ranking->searchRank($displayarray['username'],"username"); 
                                    ?></td>
            ...
            <tr>
                ...
                <td><?php
                    if ($user['gold'] == 0) { ?>
                        ...
                        <?php } else if ($user['gold'] > 0) { ?>
                            <img src='../img/admin/gold.gif' class='gold' alt='Gold' title='This user has: <?php echo $user['gold']; ?> gold' /> <?php echo $user['gold']; ?> <?php if ($_SESSION['access'] == ADMIN) { ?><a href='admin.php?p=player&uid=<?php echo $id; ?>&g'><img src='../img/admin/edit.gif' title='Give Gold'><?php } ?></a>
                </td>
            <?php }
            ?>
            </tr>
            ...
            <tr>
                ...
                <td><?php
                    if ($user['silver'] == 0) { ?>
                        ...
                        <?php } else if ($user['silver'] > 0) { ?>
                            <img src='../img/admin/silver.gif' class='silver' alt='silver' title='This user has: <?php echo $user['silver']; ?> silver' /> <?php echo $user['silver']; ?> <?php if ($_SESSION['access'] == ADMIN) { ?><a href='admin.php?p=player&uid=<?php echo $id; ?>&s'><img src='../img/admin/edit.gif' title='Give Silver'><?php } ?></a>
                </td>
            <?php }
            ?>
            </tr>
        ...
        <center><?php include('punish.php'); ?></center>
