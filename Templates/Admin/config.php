...
##  Project:       ZravianX                                                    ##
##  Version:       2011.11.08                                                  ##
##  Filename:      Templates/Admin/config.php                                  ##
##  Developed by:  Dzoki                                                       ##
##  Improved by:   ZZJHONS                                                     ##
...
<h2>
    <center>Made by Dzoki & Improved by ZZJHONS</center>
</h2>
<table id="member">
    <thead>
        <tr>
...
<table id="profile">
    ...
    <tr>
        ...
        <td>
            <font color='Red'><?php include("Templates/version.php"); ?></font>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Graphic Pack</td>
        <td><b><?php if (GP_ENABLE == true) {
                    echo "<font color='Green'>Enabled</font>";
                } else if (GP_ENABLE == false) {
    ...
    <tr>
        ...
        <td><?php if (PLUS_PRODUCTION >= 86400) {
                ...
                echo (PLUS_PRODUCTION / 3600) . ' Hour(s)';
            } ?></td>
    </tr>
    <tr>
        <td>Great Workshop</td>
        <td><b><?php if (GREAT_WKS == true) {
                    echo "<font color='Green'>Enabled</font>";
                } else if (GREAT_WKS == false) {
                    echo "<font color='Red'>Disabled</font>";
                } ?></b></td>
    </tr>
    <tr>
...
<table id="profile">
    ...
    <tr>
        <td>Limit Mailbox</td>
        <td><b><?php if (LIMIT_MAILBOX == true) {
                    echo "<font color='Green'>Enabled</font>";
    ...
    <tr>
        ...
        <td><b><?php if (INCLUDE_ADMIN == true) {
                    echo "<font color='Green'>Enabled</font>";
