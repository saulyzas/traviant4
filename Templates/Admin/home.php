...
##  Project:       ZravianX                                                    ##
##  Version:       2011.11.05                                                  ##
##  Filename:      Templates/Admin/home.php                                    ##
##  Developed by:  Dzoki                                                       ##
##  Edited by:     ZZJHONS                                                     ##
...
<font size="3">
    <b>
        <center>
            WELCOME TO <?php if ($_SESSION['access'] == MULTIHUNTER) {
                            echo 'MULTIHUNTER';
...
<br />
<center>
    You are logged in as <b><?php if ($_SESSION['access'] == MULTIHUNTER) {
                                echo '<font color="Blue">Multihunter</font>';
                            } else if ($_SESSION['access'] == ADMIN) {
