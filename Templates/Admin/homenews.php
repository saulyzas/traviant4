...
##  Project:       ZravianX                                                    ##
##  Version:       2011.11.13                                                  ##
##  Filename:      Templates/Admin/homenews.php                                ##
...
<center>
    <h1>Press submit to clear only<br />Otherwise enter the text</h1>
</center>
<?php
$ti = $_POST['n'];
$text = $_POST['txt'];
...
if ($ti or $text or $delete) {
    ...
    if (!$text) {
        unlink('Templates/News/home/home' . $ti . '.php');
        $f = fopen('Templates/News/home/home' . $ti . '.php', 'w+');
        fwrite($f, $st, $text);
        exit;
    }
    ...
    include("Templates/News/home/home" . $ti . ".php");
    echo '</center>';
}
?>
