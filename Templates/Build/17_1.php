                            ...
                            <td>
                                <button type="button" value="r1Big" <?php if (isset($_GET['s']) && $_GET['s'] == 1) {
                                                                        ...
                                                                        echo "class=\"iconFilter\"";
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;"><img src="img/x.gif" class="r1Big" alt="r1Big"></button>
                            </td>
                            <td>
                                <button type="button" value="r2Big" <?php if (isset($_GET['s']) && $_GET['s'] == 2) {
                                                                        ...
                                                                        echo "class=\"iconFilter\"";
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;"><img src="img/x.gif" class="r2Big" alt="r2Big"></button>
                            </td>
                            <td>
                                <button type="button" value="r3Big" <?php if (isset($_GET['s']) && $_GET['s'] == 3) {
                                                                        ...
                                                                        echo "class=\"iconFilter\"";
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;"><img src="img/x.gif" class="r3Big" alt="r3Big"></button>
                            </td>
                            <td>
                                <button type="button" value="r4Big" <?php if (isset($_GET['s']) && $_GET['s'] == 4) {
                                                                        ...
                                                                        echo "class=\"iconFilter\"";
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        if (isset($_GET['b'])) echo "&b=" . $_GET['b']; ?>'; return false;"><img src="img/x.gif" class="r4Big" alt="r4Big"></button>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="boxes-contents">
                <table id="ratio_select" class="buy_select transparent" cellpadding="1" cellspacing="1">
                    <tbody>
                        <tr>
                            <td>
                                <button type="button" value="marketPercentage marketPercentage1_1" <?php if (isset($_GET['v'])) {
                                                                                                        echo "class=\"iconFilter iconFilterActive\"";
                                                                                                    } else {
                                                                                                        echo "class=\"iconFilter\"";
                        ...
                        <tr>
                            <td>
                                <button type="button" value="marketPercentage marketPercentage1_x" <?php if (!isset($_GET['v'])) {
                                                                                                        echo "class=\"iconFilter iconFilterActive\"";
                                                                                                    } else {
                                                                                                        echo "class=\"iconFilter\"";
                ...
                for ($i = 0 + $u; $i <= 40 + $u; $i++) {
                    if (isset($market->onsale[$i])) {
                        ...
                        switch ($market->onsale[$i]['gtype']) {
                            case 1:
                                echo "<img src=\"img/x.gif\" class=\"r1\" alt=\"Wood\" title=\"Wood\" /> ";
                                break;
                            case 2:
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                echo "<img src=\"img/x.gif\" class=\"r4\" alt=\"Wheat\" title=\"Wheat\" /> ";
                                break;
                        }
