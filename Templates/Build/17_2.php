...
<div id="build" class="gid17">
    <div class="build_desc">
        ...
        You can trade resources with other players via the marketplace. The higher the level, the more merchants are available.
    </div>
    <?php
    include("upgrade.php");
    include("17_menu.php");
    ...
    <form method="POST" name="snd" action="build.php">
        ...
        <button type="submit" value="ok" name="s1" id="btn_ok" tabindex="8">
                ...
                <?php foreach ($market->onmarket as $offer) { ?>
                    <tr>
                        ...
                        <td class="val">
                            ...
                            switch ($offer['gtype']) {
                                case 1:
                                    echo "<img src=\"img/x.gif\" class=\"r1\" alt=\"Fa\" title=\"Wood\" /> ";
                                    break;
                                case 2:
                                    echo "<img src=\"img/x.gif\" class=\"r2\" alt=\"Agyag\" title=\"Clay\" /> ";
                                    break;
                                case 3:
                                    echo "<img src=\"img/x.gif\" class=\"r3\" alt=\"Vasérc\" title=\"Iron\" /> ";
                                    break;
                                case 4:
                                    echo "<img src=\"img/x.gif\" class=\"r4\" alt=\"Búza\" title=\"Wheat\" /> ";
                                    break;
                            }
                            echo $offer['gamt'];
