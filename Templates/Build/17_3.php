        ...
        <form method="post" name="snd" action="build.php">
            ...
            <table id="npc" cellpadding="1" cellspacing="1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="sel">
                            <input class="text" onkeyup="calculateRest();" name="m2[]" size="5" maxlength="7" <?php if (isset($_GET['r1'])) {
                                                                                                                    echo "value=\"" . $_GET['r1'] . "\"";
                                                                                                                } ?> />
                        ...
                        <td class="sel">
                            <input class="text" onkeyup="calculateRest();" name="m2[]" size="5" maxlength="7" <?php if (isset($_GET['r2'])) {
                                                                                                                    echo "value=\"" . $_GET['r2'] . "\"";
                                                                                                                } ?> />
                        ...
                        <td class="sel">
                            <input class="text" onkeyup="calculateRest();" name="m2[]" size="5" maxlength="7" <?php if (isset($_GET['r3'])) {
                                                                                                                    echo "value=\"" . $_GET['r3'] . "\"";
                                                                                                                } ?> />
                        ...
                        <td class="sel">
                            <input class="text" onkeyup="calculateRest();" name="m2[]" size="5" maxlength="7" <?php if (isset($_GET['r4'])) {
                                                                                                                    echo "value=\"" . $_GET['r4'] . "\"";
                                                                                                                } ?> />
                            <input type="hidden" name="m1[]" value="<?php echo floor($village->acrop); ?>" />
                        </td>

                        <td class="sum">Total:&nbsp;<span id="newsum"><?php if (isset($_GET['r1']) && isset($_GET['r2']) && isset($_GET['r3']) && isset($_GET['r4'])) {
            ...
            <p id="submitButton" style="display: block; ">
                <?php if ($session->userinfo['gold'] > 3) { ?>
                    <button type="submit" value="Trade resources (2/2)" id="npc_market_button" onclick="$('npc_market_button').addClass('disabled').disabled = true;document.snd.submit();">
                        <div class="button-container">
                            ...
                            <div class="button-contents">Trade resources (2/2)
                            </div>
                        </div>
                    </button><span class="npc_price"><b>3</b><img src="img/x.gif" class="gold" /> Gold</span>
            </p>
        <?php } else {
                    echo "<a href=\"plus.php\"><span class=\"none\">Not enough Gold</span></a>";
                } ?></p>
        <p id="submitText"></p>
        </form>
        <script>
