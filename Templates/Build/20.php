...
<div id="build" class="gid20">
    <p class="build_desc">
        ...
        In the stable cavalry is trained. The higher its level the faster the troops are trained.<br />
    </p>
    <?php
    include("upgrade.php");
    ?>
    ...
    <table cellpadding=\"1\" cellspacing=\"1\" class=\"under_progress\">
        ...
        <tr class="next">
            <td colspan="3">The next unit is ready <span id="timer2"><?php echo $NextFinished; ?></span> </td>
        </tr>
        </tbody>
        </table>
    <?php }
