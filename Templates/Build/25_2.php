...
<div id="build" class="gid25">
    ...
    <p>In order to settle a new village you need <b><?php $mode = CP;
                                                    $total = count($database->getProfileVillages($session->uid));
                                                    echo ${'cp' . $mode}[$total + 1]; ?></b> Culture Points. You have <b><?php echo $database->getUserField($session->uid, 'cp', 0); ?></b> Culture Points. </p>
</div>
<div class="clear">&nbsp;</div>
<div class="clear"></div>
