...
<div id="build" class="gid26">
    ...
    <p>You need <b><?php $mode = CP;
                    $total = count($database->getProfileVillages($session->uid));
                    echo ${'cp' . $mode}[$total + 1]; ?></b> Culture points to settle or chieftian a new village. <br></br>You currently have <b><?php echo $database->getUserField($session->uid, 'cp', 0); ?> </b> Culture Points</p>
</div>
