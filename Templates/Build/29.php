...
<div id="build" class="gid29">
    <div class="build_desc">
        ...
        The great barracks allows the training of additional troops. The troops cost three times as much, however. In conjunction with the normal barracks, twice as many troops can be built in the same amount of time.
    </div>
    <?php
    include("upgrade.php");
    ?>
        ...
        <form method="POST" name="snd" action="build.php">
            ...
            <button type="submit" value="ok" name="s1" id="btn_train" value="ok" class="startTraining">
                <div class="button-container">
                    ...
                    <div class="button-contents">Train</div>
                </div>
            </button>
        <?php
    } else {
    ...
    <table cellpadding=\"1\" cellspacing=\"1\" class=\"under_progress\">
        ...
        foreach ($trainlist as $train) {
            ...
            <tr class="next">
                <td colspan="3">The Next unit ready in <span id="timer2"><?php echo $NextFinished; ?></span> </td>
            </tr>
            </tbody>
            </table>
        <?php } ?>
