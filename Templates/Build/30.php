...
<div id="build" class="gid30">
    <p class="build_desc">
        ...
        The great stable allows the training of additional cavalry. These troops cost three times as much, however. <br />
    </p>
    <?php
    include("upgrade.php");
    ?>
    ...
    <table cellpadding=\"1\" cellspacing=\"1\" class=\"under_progress\">
        ...
        foreach ($trainlist as $train) {
            ...
            <tr class="next">
                <td colspan="3">The next unti is ready in <span id="timer2"><?php echo $NextFinished; ?></span> </td>
            </tr>
            </tbody>
            </table>
        <?php } ?>
