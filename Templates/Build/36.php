...
<div id="build" class="gid36">
    <div class="build_desc">
        ...
        The trapper protects your village with well hidden traps. This means that unwary enemies can be imprisoned and won't be able to harm your village any more.
    </div>
    ...
    <?php if ($building->getTypeLevel(36) > 0) { ?>
        <form method="POST" name="snd" action="build.php">
                    ...
                    <div class="action first">
                        <div class="details">
                            ...
                            <div class="showCosts">
                                ...
                                <div class="clear"></div>
                                <span class="clocks"><img class="clock" src="img/x.gif" alt="Duration"><?php $dur = $generator->getTimeFormat(round(${'u99'}['time'] * ($bid19[$village->resarray['f' . $id]]['attri'] * TRAPPER_CAPACITY / 100) / SPEED));
            ...
            <button type="submit" value="ok" name="s1" id="s1" class="startBuild">
                <div class="button-container">
                    ...
                    <div class="button-contents">Make</div>
                </div>
            </button>
        </form>
    <?php
    ...
    <table cellpadding=\"1\" cellspacing=\"1\" class=\"under_progress\">
        ...
        <tr class="next">
            <td colspan="3">The next unit will be finished in <span id="timer2"><?php echo $NextFinished; ?></span></td>
        </tr>
        </tbody>
        </table>
    <?php } ?>
