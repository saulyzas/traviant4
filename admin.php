...
<head>
    ...
    <title><?php if ($_SESSION['access'] == ADMIN) {
                echo 'Admin Control Panel - ' . SERVER_NAME;
            } else if ($_SESSION['access'] == MULTIHUNTER) {
                echo 'Multihunter Control Panel - ' . SERVER_NAME;
            } ?></title>
...
<body class="v35">
    ...
    <center>
        <br />
        <p>
            <font color="#999999">This ACP has been reworked by <a href="http://zzjhons.com">ZZJHONS</a></font>
        </p>
        <br />
    </center>
    <div class="clear"></div>
