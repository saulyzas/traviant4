                ...
                <div id="mtop">
                    ...
                    <ul id="navigation">
                        ...
                        <li id="n5" class="reports">
                            <a class=" active" href="berichte.php" accesskey="5" title="<?php echo HEADER_NOTICES; ?><?php if ($message->nunread) {
                    ...
                    <div class="contentContainer">
                        <div id="content" class="reports">
                            ...
                            <div class="contentNavi subNavi">
                                ...
                                <div title="" class="container <?php if (isset($_GET['t']) && $_GET['t'] == 5) {
                                                                    echo "active";
                                                                } else {
                                                                    echo "normal";
                                                                } ?>">
