                ...
                <div id="contentOuterContainer">
                    ...
                    <div class="contentContainer">
                        <div id="content" class="support">
                            <h1 class="titleInHeader"><?php echo Szupport; ?></h1>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="form_table_label form_table_label_support_category">
                                                        <label class="form_label" for="category"><?php echo Category; ?></label>
                                                    </td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="form_table_element form_table_element_support_message">
                                                        ...
                                                        <?php if ($_POST && $_POST['message'] == '') {
                                                            echo '<p class="error">' . USRNM_EMPTY . '</p>';
                                                        } ?>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                    ...
                                                    <td class="form_table_element form_table_element_support_submit">
                                                        <button type="submit" value="<?php echo Send; ?>" name="submit" id="submit" submit="1">
                                                            <div class="button-container">
                                                                ...
                                                                <div class="button-contents"><?php echo Send; ?></div>
                                                            </div>
                                                        </button>
                                                    </td>
                                                </tr>
