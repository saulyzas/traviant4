    ...
    <div id="background">
        ...
        <div id="content-container">
            <div id="content-menu">
                ...
                <?php include("Templates/homenews.php"); ?>
            </div>
            <div id="content-main">
                <div id="wit">
                    <div id="wit-top"></div>
        ...
        <script type="text/javascript">
            var screenshots = [{
                    'img': 'screenBig screenBig1',
                    'hl': '<?php echo SCREENSHOTS_T4_TITLE1; ?>',
                    'desc': '<?php echo $lang["screenshots2"]["desc1"]; ?>'
                },
                {
                    'img': 'screenBig screenBig2',
                    'hl': '<?php echo SCREENSHOTS_T4_TITLE2; ?>',
                    'desc': '<?php echo $lang["screenshots2"]["desc2"]; ?>'
                },
                {
                    'img': 'screenBig screenBig3',
                    'hl': '<?php echo SCREENSHOTS_T4_TITLE3; ?>',
                    'desc': '<?php echo $lang["screenshots2"]["desc3"]; ?>'
                },
                {
                    'img': 'screenBig screenBig4',
                    'hl': '<?php echo SCREENSHOTS_T4_TITLE4; ?>',
                    'desc': '<?php echo $lang["screenshots2"]["desc4"]; ?>'
                },
                {
                    'img': 'screenBig screenBig5',
                    'hl': '<?php echo SCREENSHOTS_T4_TITLE5; ?>',
                    'desc': '<?php echo $lang["screenshots2"]["desc5"]; ?>'
                },
                {
                    'img': 'screenBig screenBig6',
                    'hl': '<?php echo SCREENSHOTS_T4_TITLE6; ?>',
                    'desc': '<?php echo $lang["screenshots2"]["desc6"]; ?>'
                },
                {
                    'img': 'screenBig screenBig7',
                    'hl': '<?php echo SCREENSHOTS_T4_TITLE7; ?>',
                    'desc': '<?php echo $lang["screenshots2"]["desc7"]; ?>'
                },
                {
                    'img': 'screenBig screenBig8',
                    'hl': '<?php echo SCREENSHOTS_T4_TITLE8; ?>',
                    'desc': '<?php echo $lang["screenshots2"]["desc8"]; ?>'
                }
            ];
        </script>
    </div>
