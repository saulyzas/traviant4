                                        ...
                                        <table class="transparent loginTable">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="submit" value="<?php echo LOGIN; ?>" name="s1" id="s1" onClick="document.login.w.value=screen.width+':'+screen.height;">
                                                    ...
                                                    <table class="transparent pwForgottenTable" id="pw_forgotten_form" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr class="mail">
                                                                ...
                                                                <td><input class="text" type="text" name="pw_email" value=""><br>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <button type="submit" value="<?php echo LOGIN_PW_BTN; ?>" name="s2" id="s2">
                                                                        <div class="button-container">
                                                                            <div class="button-position">
                                                                                <div class="btl">
                                                                                    <div class="btr">
                                                                            ...
                                                                            <div class="button-contents"><?php echo LOGIN_PW_BTN; ?></div>
                                                                        </div>
                                                                    </button>
                                                                </td>
                                                            </tr>
