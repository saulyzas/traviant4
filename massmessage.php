...
if (isset($_GET['send']) && isset($_GET['from'])) {
    ...
    if ($_GET['from'] + $max_per_pass <= $users_count) $plus = $max_per_pass;
    else $plus = $users_count - $_GET['from'];
...
<head>
    ...
    <style>
        ...
        div.messages div#message_container div#message_toolbarWindows div,
        ...
        <div id="mid">
            ...
            <div id="content" class="login">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 10pt; text-align: left;">
                                        <input type="text" style="width: 240px;" class="fm" name="subject" value="" size="30">
                                    </td>
                                </tr>
                                <tr>
                ...
                <?php } elseif (@$NextStep2) { ?>
                    <script>
                        document.location.href = 'massmessage.php?send=true&from=0'
                    </script>
