                ...
                <div id="mtop">
                    ...
                    <ul id="navigation">
                        ...
                        if (count($database->getMessage($session->uid, 9)) >= 1000) {
                            ...
                            $unmsg = count($database->getMessage($session->uid, 9));
                        }

                        if (count($database->getNotice5($session->uid)) >= 1000) {
                            $unnotice = "+1000";
                        } else {
                            $unnotice = count($database->getNotice5($session->uid));
                        }
                        ?>
                        <li id="n5" class="reports">
                            <a href="berichte.php" accesskey="5" title="<?php echo HEADER_NOTICES; ?><?php if ($message->nunread) {
                                                                                                            echo ' (' . count($database->getNotice5($session->uid)) . ')';
                                                                                                        } ?>"></a>
                            <?php
                            if ($message->nunread) {
			...
			<div class=\"bubble-content\">" . $unnotice . "</div></div>";
                        ...
                        <li id="n6" class="messages">
                            <a href="nachrichten.php" accesskey="6" title="<?php echo HEADER_MESSAGES; ?><?php if ($message->unread) {
                                                                                                                echo ' (' . count($database->getMessage($session->uid, 9)) . ')';
                                                                                                            } ?>"></a>
                            <?php
                            if ($message->unread) {
                    ...
                    <div class="contentContainer">
                        <div id="content" class="warsim">
                            ...
                            <form action="warsim.php" method="post">
                                ...
                                $tribe = isset($_POST['mytribe']) ? $_POST['mytribe'] : $session->tribe;
                                if (count($target) > 0) {
                                    include("Templates/Simulator/att_" . $tribe . ".php");
                                            ...
                                            <td>
                                                <div class="fighterType">
                                                    <div class="boxes boxesColor red">
                                                        ...
                                                        <div class="boxes-contents">Támadók </div>
                                                    </div>
                                                </div>
                                                <div class="clear"></div>
                                            ...
                                            <td>
                                                <div class="fighterType">
                                                    <div class="boxes boxesColor green">
                                                        ...
                                                        <div class="boxes-br"></div>
                                                        <div class="boxes-bc"></div>
                                                        <div class="boxes-contents">Védők </div>
                                                    </div>
                                                </div>
                                                <div class="clear"></div>

                                                <div class="choice">
                                                    <label><input class="check" type="checkbox" name="a2_v1" value="1" <?php if (in_array(1, $target)) {
                                                                                                                            echo "checked";
                                                                                                                        } ?>> Római</label><br>
                                                    <label><input class="check" type="checkbox" name="a2_v2" value="1" <?php if (in_array(2, $target)) {
                                                                                                                            echo "checked";
                                                                                                                        } ?>> Germán</label><br>
                                                    <label><input class="check" type="checkbox" name="a2_v3" value="1" <?php if (in_array(3, $target)) {
                                                                                                                            echo "checked";
                                                                                                                        } ?>> Gall</label><br>
                                                    <label><input class="check" type="checkbox" name="a2_v4" value="1" <?php if (in_array(4, $target)) {
                                                                                                                            echo "checked";
                                                                                                                        } ?>> Természet</label>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="fighterType">
                                                    <div class="boxes boxesColor darkgray">
                                                        ...
                                                        <div class="boxes-br"></div>
                                                        <div class="boxes-bc"></div>
                                                        <div class="boxes-contents">Harctípus </div>
                                                    </div>
                                                </div>
                                                <div class="clear"></div>

                                                <div class="choice">
                                                    <label><input class="radio" type="radio" name="ktyp" value="0" <?php if ($form->getValue('ktyp') == 0 || $form->getValue('ktyp') == "") {
                                                                                                                        echo "checked";
                                                                                                                    } ?>> Normál</label><br />

                                                    <label><input class="radio" type="radio" name="ktyp" value="1" <?php if ($form->getValue('ktyp') == 1) {
                                                                                                                        echo "checked";
                                                                                                                    } ?>> Rablótámadás</label><br />
                                ...
                                <p class="btn"><button type="submit" value="Támadás szimulálása" name="s1" id="btn_ok">
                                        <div class="button-container">
                                            ...
                                            <div class="button-contents">Támadás szimulálása</div>
                                        </div>
                                    </button></p>
                            </form>
                        </div>
